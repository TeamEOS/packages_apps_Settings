...
public class LongSwipePreference extends DialogPreference implements
    ...
    private void loadDefaults(Bundle b) {
        leftLandDef = Math.round(b.getFloat(EosActionUtils.isNormalScreen() ? Fling.CONFIG_FlingLongSwipeVerticalDown
                        : Fling.CONFIG_FlingLongSwipeLandscapeLeft) * 100);
        rightLandDef = Math.round(b.getFloat(EosActionUtils.isNormalScreen() ? Fling.CONFIG_FlingLongSwipeVerticalUp
        ...
        int min = Math.round((Float) EosActionUtils.getValue(mContext, "config_flingMinLongSwipeThreshold",
                EosActionUtils.DIMEN, EosActionUtils.FORMAT_FLOAT, pkg) * 100);
        int max = Math.round((Float) EosActionUtils.getValue(mContext, "config_flingMaxLongSwipeThreshold",
                EosActionUtils.DIMEN, EosActionUtils.FORMAT_FLOAT, pkg) * 100);
	...
	protected void onBindDialogView(View view) {
		...
		if (EosActionUtils.isNormalScreen()) {
